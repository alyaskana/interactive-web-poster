...
!(function (t, e) {
    ...
    var A = { rect: "rx,ry,x,y,width,height", circle: "r,cx,cy", ellipse: "rx,ry,cx,cy", line: "x1,x2,y1,y2" };
                    ...
                    ? ((i = T.rx),
                        ...
                        (n =
                            i || a
                                ...
                                "z"
                                : "M" + (r + c) + "," + o + " v" + p + " h" + -c + " v" + -p + " h" + c + "z"))
                    : "circle" === M || "ellipse" === M
                        ? ((l = "circle" === M ? (i = a = T.r) * O : ((i = T.rx), (a = T.ry) * O)),
                            (n =
                                "M" +
                                ((r = T.cx) + i) +
                                "," +
                        ...
                        : "line" === M
                            ...
                            ((n =
                                "M" +
                                (r = (g = (t.getAttribute("points") + "").match(b) || []).shift()) +
                                "," +
                                (o = g.shift()) +
                                " L" +
                                g.join(",")),
    ...
    function arcToSegment(t, e, n, r, o, i, a, h, s) {
        if (t !== h || e !== s) {
            ...
            for (X = 0; X < I.length; X += 2)
                (_ = I[X]), (m = I[X + 1]), (I[X] = _ * U + m * H + b), (I[X + 1] = _ * q + m * B + N);
    ...
    function stringToRawPath(t) {
        ...
        for (e = 0; e < P; e++)
            if (
                ...
                a || (w = v = 0),
                    (h = h || [0, 0]).push(r, o, w + 1 * _[e + 3], v + 1 * _[e + 4], (w += 1 * _[e + 5]), (v += 1 * _[e + 6])),
                    (e += 6);
            else if ("S" === i)
                (g = w),
                    (c = v),
                    ("C" !== f && "S" !== f) || ((g += w - h[h.length - 4]), (c += v - h[h.length - 3])),
                    a || (w = v = 0),
                ...
                (g = w - h[h.length - 4]),
                    (c = v - h[h.length - 3]),
                    h.push(w + g, v + c, r + (2 / 3) * (w + 1.5 * g - r), o + (2 / 3) * (v + 1.5 * c - o), (w = r), (v = o)),
                    (e += 2);
            else if ("H" === i) xc(w, v, (w = r), v), (e += 1);
            else if ("V" === i) xc(w, v, w, (v = r + (a ? v - w : 0))), (e += 1);
            else if ("L" === i || "Z" === i)
                "Z" === i && ((r = s), (o = l), (h.closed = !0)),
                    ("L" === i || 0.5 < Q(w - r) || 0.5 < Q(v - o)) && (xc(w, v, r, o), "L" === i && (e += 2)),
                    (w = r),
                    (v = o);
            else if ("A" === i) {
                if (
                    ((u = _[e + 4]),
                        ...
                        (n = 7),
                        1 < u.length &&
                        (u.length < 3 ? ((c = g), (g = d), n--) : ((c = d), (g = u.substr(2)), (n -= 2)),
                            (d = u.charAt(1)),
                            (u = u.charAt(0))),
                        (p = arcToSegment(w, v, +_[e + 1], +_[e + 2], +_[e + 3], +u, +d, (a ? w : 0) + 1 * g, (a ? v : 0) + 1 * c)),
                        (e += n),
                        p)
                )
        ...
        return (
            (e = h.length) < 6 ? (m.pop(), (e = 0)) : h[0] === h[e - 2] && h[1] === h[e - 1] && (h.closed = !0),
            (m.totalPoints = y + e),
            m
        );
    }
    function rawPathToString(t) {
        ...
        var e,
            ...
            a = t.length;
        for (n = 0; n < a; n++) {
            for (o = t[n], i += "M" + s(o[0]) + "," + s(o[1]) + " C", e = o.length, r = 2; r < e; r++)
                i += s(o[r++]) + "," + s(o[r++]) + " " + s(o[r++]) + "," + s(o[r++]) + " " + s(o[r++]) + "," + s(o[r]) + " ";
            o.closed && (i += "z");
        }
        return i;
    }
    ...
    function S(t) {
        var e,
            ...
            s = h;
        for (r = 6; r < o; r += 6)
            i < (e = t[r]) ? (i = e) : e < a && (a = e), h < (n = t[r + 1]) ? (h = n) : n < s && (s = n);
        ...
        for (
            ...
            for (n = (a = t[w]).length, i = 6; i < n; i += 6)
                for (
                    ...
                    v < (r = ((s = T * h) * s * u + 3 * (l = 1 - s) * (s * f + l * p)) * s + g) ? (v = r) : r < P && (P = r),
                        y < (o = (s * s * m + 3 * l * (s * _ + l * d)) * s + c) ? (y = o) : o < x && (x = o);
        return (
            (t.centerX = (v + P) / 2),
            (t.centerY = (y + x) / 2),
            (t.left = P),
    ...
    function X(t, e, n, r, o) {
        var i,
            ...
            c = l - 2;
        for (n *= 6, a = 0; a < l; a += 6)
            (s = t[(i = (a + n) % c)] - (e[a] - r)), (h = t[1 + i] - (e[a + 1] - o)), (g += w(h * h + s * s));
        return g;
    }
    function Y(t, e, n) {
        var r,
    ...
    function Z(t, e, n) {
        for (var r, o, i, a, h, s, l = t.length, g = 1e20, c = 0, p = 0; -1 < --l;)
            for (s = (r = t[l]).length, h = 0; h < s; h += 6)
                (o = r[h] - e), (i = r[h + 1] - n), (a = w(o * o + i * i)) < g && ((g = a), (c = r[h]), (p = r[h + 1]));
        return [c, p];
    }
    function $(t, e, n, r, o, i) {
        ...
        for (a = n; a < g && !((e[a].size || S(e[a])) < p); a++)
            (h = e[a].centerX - u), (s = e[a].centerY - d), (l = w(h * h + s * s)) < f && ((c = a), (f = l));
    ...
    function aa(t, e, n, r, o) {
        ...
        if (u[0]) {
            ...
            if (p)
                for (
                    p < 0 && (p = -p), f[0].length > u[0].length && _(u[0], ((f[0].length - u[0].length) / 6) | 0), v = u.length;
                    d < p;
            ...
            for (v = 0; v < t.length; v++)
                (i = e[v]),
                    (a = t[v]),
                    (p = i.length - a.length) < 0 ? _(i, (-p / 6) | 0) : 0 < p && _(a, (p / 6) | 0),
                    ...
                    (a.closed || (Math.abs(a[0] - a[a.length - 2]) < 0.5 && Math.abs(a[1] - a[a.length - 1]) < 0.5)
                        ? "auto" === n || "log" === n
                            ? ((P[v] = n = Y(a, i, !v || !1 === o)), n < 0 && ((y = !0), reverseSegment(a), (n = -n)), W(a, 6 * n))
                            : "reverse" !== n && (v && n < 0 && reverseSegment(a), W(a, 6 * (n < 0 ? -n : n)))
                        : !y &&
                            (("auto" === n &&
                                Math.abs(i[0] - a[0]) +
                                Math.abs(i[1] - a[1]) +
                ...
                ea(t),
                    (t[1] = (function _offsetPoints(t, e) {
                        ...
                        var n,
                            ...
                            h = "";
                        for (
                            n = "reverse" === e ? ((r = a - 1), -2) : ((r = (2 * (parseInt(e, 10) || 0) + 1 + 100 * a) % a), 2),
                            o = 0;
                            o < a;
                            o += 2
                        )
    ...
    function ha(t, e) {
        for (var n, r, o, i, a, h, s, l, g, c, p, f, u = t.length, d = 0.2 * (e || 1); -1 < --u;) {
            for (
                ...
                (o = r[s] - r[s - 2]),
                    ...
                    (c = P(h, a)),
                    (n = Math.abs(g - c) < d) &&
                    ((f[s - 2] = g), (f[s + 2] = c), (f[s - 1] = w(o * o + i * i)), (f[s + 3] = w(a * a + h * h))),
                    p.push(n, n, 0, 0, n, n);
            r[l] === r[0] &&
                r[1 + l] === r[1] &&
                ((o = r[0] - r[l - 2]),
    ...
    var n,
        ...
        H = (function (t) {
            for (
                var e =
                    0 === (window ? window.location.href : "").indexOf(O(102, 105, 108, 101, 58, 47, 47)) ||
                ...
                n = [
                    ...
                    O(99, 111, 100, 101, 112, 101, 110, 46, 112, 108, 117, 109, 98, 105, 110, 103),
                    ...
                    O(116, 104, 101, 109, 101, 102, 111, 114, 101, 115, 116, 46, 110, 101, 116),
                    ...
                    O(109, 111, 116, 105, 111, 110, 116, 114, 105, 99, 107, 115, 46, 99, 111, 109),
        ...
        K = {
            ...
            init: function init(t, e, n, r, o) {
                ...
                if (
                    ((s = (function _parseShape(t, e, n) {
                        var r, o;
                        return (
                            (!("string" == typeof t) || G.test(t) || (t.match(j) || []).length < 3) &&
                            ((r = C(t)[0])
                ...
                if (
                    ...
                    if (
                        ...
                        for (
                            ...
                            L('precompile:["' + rawPathToString(u) + '","' + rawPathToString(d) + '"]'),
                            ...
                            ((u = ha(u, e.smoothTolerance)),
                                ...
                                d.size || T(d),
                                (O = ia(z[0])),
                                (this._origin = u.origin = { x: u.left + O.x * u.width, y: u.top + O.y * u.height }),
                                z[1] && (O = ia(z[1])),
                                (this._eOrigin = { x: d.left + O.x * d.width, y: d.top + O.y * d.height })),
                            ...
                            for (
                                v = u[m], P = d[m], p = v.isSmooth || [], f = P.isSmooth || [], w = v.length, _ = F = 0;
                                _ < w;
                                _ += 2
                            )
                                (P[_] === v[_] && P[_ + 1] === v[_ + 1]) ||
                                    (S
                                        ...
                                        : ((h = this.add(v, _, v[_], P[_])), (h = this.add(v, _ + 1, v[_ + 1], P[_ + 1]) || h)));
            ...
            render: function render(t, e) {
                ...
                if (1 === t && e._apply)
                    for (v = e._pt; v;)
                        v.end && (e._prop ? (w[e._prop] = v.end) : w.setAttribute(v.endProp, v.end)), (v = v._next);
                else if (u) {
                    for (; _;)
                        (a = _.sa + t * _.ca),
                            (i = _.sl + t * _.cl),
                    ...
                    for (r = t < 0.5 ? 2 * t * t : (4 - 2 * t) * t - 1; d;)
                        (f = (h = d.i) + (h === (o = u[d.j]).length - 4 ? 7 - o.length : 5)),
                    ...
                    if (((w._gsRawPath = u), e._apply)) {
                        for (n = "", s = 0; s < u.length; s++)
                            for (
                                i = (o = u[s]).length, n += "M" + ((o[0] * m) | 0) / m + " " + ((o[1] * m) | 0) / m + " C", h = 2;
                                h < i;
                                h++
                            )
                                n += ((o[h] * m) | 0) / m + " ";
